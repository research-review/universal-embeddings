...
# https://github.com/xxx-group/embeddings.cc
#
...
class EmbeddingsCcIndex():
    WEBSERVICE_URL = 'http://embeddings.cs.uni-xxx.de:8008'
    ...
    def ping(self, seconds=1):
        ...
        Returns:
        200: Success
        502: Webservice unavailable (also if not in uni network, check VPN)
